export const flowerDesc = "Mobile app that uses a concolutional neural network to identify what species of flower your image is.";
...
export const flowerExDesc = "Here are images of the FlowerID app. More examples can be found on the Play Store page"

export const reindenterDesc = "Web app/callable REST API that reformats your code, assuming your code is in a c-style syntax.";
...
export const reindenterExDesc = "Here is an example of the Re-Indenter app where it formats a single line of code into properly spaced code"
